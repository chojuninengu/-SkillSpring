    ...
    <ProtectedRoute>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {loading ? (
          ...
          <div className="mt-8">
            <h2 className="text-lg font-medium text-gray-900">My Enrolled Courses</h2>
            <div className="mt-4 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {enrollments.length === 0 ? (
                <p className="text-gray-500 col-span-full">
                  You haven't enrolled in any courses yet.{' '}
                  <a href="/courses" className="text-primary-600 hover:text-primary-500">
                    Browse our courses
                  </a>{' '}
                  to get started!
                </p>
                ...
                enrollments.map((enrollment) => (
                  ...
                  >
                    <div className="px-4 py-5 sm:p-6">
                      ...
                      <div className="mt-4">
                        <label
                          htmlFor={`progress-${enrollment.id}`}
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleUpdateProgress(enrollment.id, parseInt(e.target.value))
                          }
